module Evercam
  class V1PTZRoutes < Grape::API
    ...
    post '/cameras/:id/ptz/home/set' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
    ...
    post '/cameras/:id/ptz/presets/:preset_token' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
    ...
    post '/cameras/:id/ptz/presets/create/:preset_name' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
    ...
    post '/cameras/:id/ptz/presets/go/:preset_token' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
    ...
    post '/cameras/:id/ptz/continuous/start/:direction' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
    ...
    post '/cameras/:id/ptz/continuous/zoom/:mode' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
    ...
    post '/cameras/:id/ptz/continuous/stop' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
    ...
    post '/cameras/:id/ptz/relative' do
      camera = get_cam(params[:id])
      rights = requester_rights_for(camera)
      raise AuthorizationError.new if !rights.allow?(AccessRight::EDIT)
