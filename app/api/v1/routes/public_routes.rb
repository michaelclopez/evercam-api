              ...
              point[point.length] = [
                {
                  ...
                  "properties": {
                    "marker-color": "#DC4C3F",
                    "Current Thumbnail Tag": "<img width='140' src='https://media.evercam.io/v1/cameras/#{camera.exid}/thumbnail?' />",
                    "Current Thumbnail URL": "https://media.evercam.io/v1/cameras/#{camera.exid}/thumbnail?",
